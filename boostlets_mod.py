...
def indexs_max_conv_mask_maskedDict(mask, Sk, f_plot=False):
    ...
    Specs = np.fft.fft2(mask)[...,np.newaxis] * np.fft.fft2(MSk, axes=(0, 1)) # conv -> mult in Fou space
